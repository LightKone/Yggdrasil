 ...
 * Setup
 *********************************************************/
int setupSimpleChannel(Channel* ch, NetworkConfig* ntc){ //more parameters could be added to support multiple types of decision making on the interface to operate on

	extern int nl_error;

	ch->type = ntc->type;

	MacNetworkConfig* ntconf  = &ntc->config.macntconf;
