...
#include "protocols/ip/dissimination/plumtree_mem_optimized.h"

#include "protocols/ip/data_transfer/block_data_transfer_plumtree.h"
...
int main(int argc, char* argv[]) {
    ...
    registerProtocol(PROTO_BLOCK_DATA_TRANSFER, (Proto_init) block_data_transfer_plumtree_init, dt);
